  ...
  updateLogs: [
    {
      ...
      version: 'v3.3.27',
      content: `v3.3.27更新。
- 「球罐」更名为「糖罐」，点击糖罐后瓶子与内部糖果同步自然晃动
- 「奖励商店」全面改造成「扭蛋机」：统一使用糖果作为货币，去掉普通兑换，仅保留扭蛋玩法
- 新增大扭蛋机视觉与交互：奖池展示、扭蛋机动画、点击「抽扭蛋」后 lever 转动+内部彩球晃动+胶囊掉落动画
- 中奖弹窗改为绿色边框奖励卡样式，显示中奖奖品与「收下」按钮
- 「新增奖励」表单增加「中奖概率权重」字段，可在新增奖品时配置中奖概率`,
      impact: '习惯打卡奖励体系升级为扭蛋机，糖罐与糖果货币统一',
    },
    {
      date: '2026-08-10',
      version: 'v3.3.26',
