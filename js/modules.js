...
const ModuleConfig = {
  modules: {
    ...
    hot: {
      ...
      help: {
        title: '平台热点',
        sections: [
          { label: '这个功能做什么', text: '整合四类热点内容：1) 平台热搜——实时获取抖音、微博、小红书、B站、今日头条的热搜榜单；2) 生活热点——AI抓取抖音、小红书、B站生活类热门话题与趋势；3) AI热点——真实抓取 GitHub/AI门户/社媒 以及 抖音/B站/小红书 的 AI 类热门话题，并整合AI行业资讯；4) 竞品参考——列出 xuan酱、不一书、西门聪明蛋XD、老陈是小凳、不喝九 等 AI 科普博主的代表选题与风格，刷新可让 AI 基于当前热点推断各家最新选题方向。' },
          { label: '怎么操作', text: '点击顶部大标签切换四类热点。平台热搜下再点击平台标签切换不同平台。AI热点为真实抓取、生活热点由Deepseek生成、竞品参考的"最新选题"刷新由Deepseek推断。' },
          { label: '完成后会发生什么', text: '平台热搜数据每30分钟自动缓存；AI生成的生活/AI热点每次刷新都会重新生成。' },
          { label: '如何撤销', text: '本模块为只读模式，不会修改任何数据。' },
  ...
  mobileNav: ['today', 'dashboard', 'topics', 'content', 'decomp', 'hot', 'settings'],
