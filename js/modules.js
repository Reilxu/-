  ...
  modules: {
    ...
    habits: {
      ...
      help: {
        title: '习惯打卡',
        sections: [
          { label: '这个功能做什么', text: '把"小日常"式极简习惯打卡嵌入工作台：今日打卡、习惯管理、番茄钟、碎念笔记、数据统计（连续天数/完成率/热力图）和糖球积分奖励商店。所有数据保存在本地，登录后自动同步到云端，与其他模块一样多端可用。' },
          { label: '怎么操作', text: '今日打卡页列出当天需要完成的习惯，点击卡片即可打卡（带翻转动画与彩花）；时长类/数量类习惯点击后填入数值。底部子标签可在「今日打卡 / 统计 / 番茄钟 / 碎念笔记 / 奖励商店 / 设置」之间切换。设置页可新增习惯、从模板库一键导入、编辑或归档。' },
          { label: '糖球积分', text: '每次打卡得 1 颗普通糖球（=1 积分）；连续打卡满 7/14/21/30 天额外得彩虹糖球（=2 积分）；番茄钟完成得专注糖球。积分在奖励商店兑换你自定义的奖励，也可花 50 积分抽盲盒。' },
...
- 新增「球罐」独立标签页（位于统计右侧）：玻璃罐盛装已完成的糖果，支持周/月/年/自定义日期筛选，点击瓶子触发晃动动画+糖果晃动
- 球罐下方展示所选周期内每个习惯的完成次数与对应糖果数
